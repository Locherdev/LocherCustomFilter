...
// {$smarty.block.parent}
Ext.define('Shopware.apps.LocherCustomFilter.view.detail.Window', {
    ...
    getTabs: function() {
        ...
        result.push(Ext.create('Shopware.apps.LocherCustomFilter.view.detail.MyOwnTab'));
...
console.log("My very first override");
//{/block}
